# read in the data
mydata <- read.table("h://mbg_db_reporting//reports//20150312_FAST_FT_counts_by_submission_month_csv.csv",
  header=TRUE, sep=",")
...
xyplot(mydata$NumForms ~ mydata$yrmo |factor(mydata$COUNTY_ID),scales=list(relation="free"), 
 ...
 ##saves file as pdf
pdf(file="h://mbg_db_reporting//reports//20150312_FASTbymo.pdf", paper="letter") 
...
scales=list(
 ...
 type="b",  layout = c(1,6), xlab="Month", 
             ylab="Num. of FAST Family Together",
 pch=NA_integer_,
 main="FAST Submissions by County and Month",
